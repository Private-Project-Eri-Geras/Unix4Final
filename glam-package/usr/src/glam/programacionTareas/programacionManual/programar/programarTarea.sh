...
mostrar_ayuda() {
    dialog --title "Help" --msgbox \
        "\n\
    Minuto (0-59)\n\
    Se especifica el minuto en el que se ejecutará el script.\n\n\
    Hora (0-23)\n\
    Se especifica la hora en la que se ejecutará el script.\n\n\
    Día del mes (1-31)\n\
    Se especifica el día del mes en el que se ejecutará el script.\n\n\
    Mes (1-12)\n\
