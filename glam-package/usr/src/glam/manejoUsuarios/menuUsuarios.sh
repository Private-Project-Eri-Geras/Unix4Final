...
while true; do
    ...
    case $option in
    1)
        (source "/usr/src/glam/manejoUsuarios/usuarios/altas/masiva.sh")
        ;;
    2)
        (source "/usr/src/glam/manejoUsuarios/usuarios/altas/manual.sh")
        ;;
    3)
        (source "/usr/src/glam/manejoUsuarios/usuarios/bajas/masiva.sh")
        ;;
    4)
        (source "/usr/src/glam/manejoUsuarios/usuarios/bajas/manual.sh")
        ;;
    5)
        (source "/usr/src/glam/manejoUsuarios/usuarios/contraseñas/masiva.sh")
        ;;
    6)
        (source "/usr/src/glam/manejoUsuarios/usuarios/contraseñas/manual.sh")
        ;;
    *)
